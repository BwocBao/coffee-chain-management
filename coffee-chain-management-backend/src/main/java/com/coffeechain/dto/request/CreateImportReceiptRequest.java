...
public class CreateImportReceiptRequest {
    @Schema(description = "Ma kho nhap hang", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
    private Long maKho;

    @Schema(description = "Ma nha cung cap", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
    private Long maNhaCungCap;

    @Schema(description = "Ghi chu phieu nhap", example = "Nhap bo sung dau ngay")
    private String ghiChu;

    @Schema(description = "Danh sach nguyen lieu trong phieu nhap", requiredMode = Schema.RequiredMode.REQUIRED)
