...
public class CreateTransferReceiptItemRequest {
    @Schema(description = "Ma nguyen lieu can dieu chuyen", example = "2", requiredMode = Schema.RequiredMode.REQUIRED)
    private Long maNguyenLieu;

    @Schema(description = "Tong so luong dieu chuyen", example = "300", requiredMode = Schema.RequiredMode.REQUIRED)
