...
public class CreateTransferReceiptRequest {
    ...
    @Schema(description = "Bat che do chon lo thu cong. Neu false, backend tu dieu chuyen theo FEFO", example = "false")
    private Boolean chonLoThuCong = false;

    @Schema(description = "Ghi chu phieu dieu chuyen", example = "Dieu chuyen nguyen lieu tu kho tong ve chi nhanh")
    private String ghiChu;

    @Schema(description = "Danh sach nguyen lieu trong phieu dieu chuyen", requiredMode = Schema.RequiredMode.REQUIRED)
