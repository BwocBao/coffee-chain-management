...
public class CreateImportReceiptItemRequest {
    @Schema(description = "Ma nguyen lieu can nhap", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
    private Long maNguyenLieu;

    @Schema(description = "So luong nhap", example = "1000", requiredMode = Schema.RequiredMode.REQUIRED)
    private BigDecimal soLuongNhap;

    @Schema(description = "Don gia nhap", example = "120000", requiredMode = Schema.RequiredMode.REQUIRED)
