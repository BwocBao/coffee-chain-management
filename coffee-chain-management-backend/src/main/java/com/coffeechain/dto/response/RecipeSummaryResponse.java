...
@Schema(description = "DTO response RecipeSummaryResponse. Thong tin tom tat san pham/cong thuc tren danh sach.")
public record RecipeSummaryResponse(
        ...
        @Schema(description = "So nguyen lieu trong cong thuc", example = "3")
        Integer soNguyenLieu
) {
}
