...
@Schema(description = "DTO response ExpiryLookupResponse. Swagger hien thi cac field backend tra ve cho frontend.")
public class ExpiryLookupResponse {
    ...
    @Schema(description = "Danh sach trang thai hop le")
    private List<OptionDto> statuses = new ArrayList<>();
    @Schema(description = "Gia tri $field trong response tra ve frontend (warning levels).")
