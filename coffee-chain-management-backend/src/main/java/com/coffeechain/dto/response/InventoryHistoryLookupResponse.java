...
@Schema(description = "DTO response InventoryHistoryLookupResponse. Swagger hien thi cac field backend tra ve cho frontend.")
public class InventoryHistoryLookupResponse {
    ...
    @Schema(description = "Gia tri $field trong response tra ve frontend (transaction types).")
