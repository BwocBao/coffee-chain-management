...
@Schema(
    description =
        "DTO response InventoryStockOptionResponse. Swagger hien thi cac field backend tra ve cho frontend.")
public class InventoryStockOptionResponse {
  ...
  public InventoryStockOptionResponse(
      Long id, String name, String description, BigDecimal soLuongTon) {
    this.id = id;
    this.name = name;
