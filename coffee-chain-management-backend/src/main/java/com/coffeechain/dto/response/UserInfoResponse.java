...
public class UserInfoResponse {
    ...
    @Schema(description = "Tên chi nhánh của người dùng. Có thể null với ADMIN.", example = "Chi nhánh trung tâm")
    private String tenChiNhanh;

    @Schema(description = "Danh sách permission code của người dùng", example = "[\"USER:CREATE\", \"ROLE:VIEW\"]")
    ...
    public UserInfoResponse(Long maNguoiDung, String tenDangNhap, Long maVaiTro, String tenVaiTro,
                            Long maChiNhanh, String tenChiNhanh, Set<String> permissions, LocalDateTime expiredAt) {
