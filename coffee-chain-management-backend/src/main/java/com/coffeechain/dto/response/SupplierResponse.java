...
@Schema(
    description =
        "DTO response SupplierResponse. Swagger hien thi cac field backend tra ve cho frontend.")
public class SupplierResponse {
  ...
  public SupplierResponse(
      Long maNhaCungCap, String tenNhaCungCap, String soDienThoai, String email, String diaChi) {
