...
@Schema(description = "DTO response IngredientResponse. Swagger hien thi cac field backend tra ve cho frontend.")
public class IngredientResponse {
    ...
    @Schema(description = "Gia tri $field trong response tra ve frontend (ky hieu don vi tinh).", example = "Gia tri mau")
