...
@Schema(description = "DTO response StocktakeLookupResponse. Swagger hien thi cac field backend tra ve cho frontend.")
public class StocktakeLookupResponse {
    ...
    @Schema(description = "Gia tri $field trong response tra ve frontend (handling options).")
