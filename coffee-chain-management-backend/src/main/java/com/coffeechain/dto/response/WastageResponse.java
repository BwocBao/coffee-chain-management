...
@Schema(
    description =
        "DTO response WastageResponse. Swagger hien thi cac field backend tra ve cho frontend.")
public class WastageResponse {
  ...
  @Schema(
      description = "Gia tri $field trong response tra ve frontend (ngay hao hut).",
  ...
  @Schema(
      description = "Gia tri $field trong response tra ve frontend (ma nguoi bao cao).",
      example = "1")
  private Long maNguoiBaoCao;

  @Schema(
      description = "Gia tri $field trong response tra ve frontend (ten nguoi bao cao).",
