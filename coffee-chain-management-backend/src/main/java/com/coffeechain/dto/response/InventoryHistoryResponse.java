...
@Schema(description = "DTO response InventoryHistoryResponse. Swagger hien thi cac field backend tra ve cho frontend.")
public class InventoryHistoryResponse {
    @Schema(description = "Gia tri $field trong response tra ve frontend (ma nhat ky kho).", example = "1")
    ...
    @Schema(description = "Gia tri $field trong response tra ve frontend (loai giao dich).", example = "Gia tri mau")
    private String loaiGiaoDich;
    @Schema(description = "Gia tri $field trong response tra ve frontend (ten chung tu).", example = "Tên hiển thị mẫu")
    private String tenChungTu;
    @Schema(description = "Gia tri $field trong response tra ve frontend (ma chung tu).", example = "1")
    private Long maChungTu;

    @Schema(description = "Gia tri $field trong response tra ve frontend (so luong thay doi).", example = "100.5")
    private BigDecimal soLuongThayDoi;
    @Schema(description = "Gia tri $field trong response tra ve frontend (so luong truoc).", example = "100.5")
    private BigDecimal soLuongTruoc;
    @Schema(description = "Gia tri $field trong response tra ve frontend (so luong sau).", example = "100.5")
    private BigDecimal soLuongSau;

    @Schema(description = "Gia tri $field trong response tra ve frontend (thoi gian).", example = "2026-05-22T08:30:00")
    private LocalDateTime thoiGian;

    @Schema(description = "Gia tri $field trong response tra ve frontend (ma nguoi thao tac).", example = "1")
    private Long maNguoiThaoTac;
    @Schema(description = "Gia tri $field trong response tra ve frontend (ten nguoi thao tac).", example = "Tên hiển thị mẫu")
