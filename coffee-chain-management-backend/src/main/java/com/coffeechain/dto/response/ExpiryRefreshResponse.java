...
@Schema(description = "DTO response ExpiryRefreshResponse. Swagger hien thi cac field backend tra ve cho frontend.")
public class ExpiryRefreshResponse {
    @Schema(description = "Thong bao ket qua xu ly", example = "Gia tri mau")
    private String message;
    @Schema(description = "Gia tri $field trong response tra ve frontend (refreshed at).", example = "2026-05-22T08:30:00")
