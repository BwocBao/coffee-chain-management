...
public class ForgotPasswordResponse {
  @Schema(
      description = "Email da duoc che bot de hien thi an toan",
      example = "a***@phungloc.local")
  ...
  @Schema(
      description =
          "Ma xac nhan chi tra ve khi app.auth.password-reset.return-code-in-response=true")
