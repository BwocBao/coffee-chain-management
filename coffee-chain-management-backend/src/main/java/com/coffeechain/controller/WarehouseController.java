...
@Tag(
    name = "Quan ly thong tin kho",
    description =
        "Nhom API Quan ly thong tin kho. Swagger mo ta quyen can co, request, response va luong su dung chinh.")
@RestController
...
public class WarehouseController {
  ...
  public ResponseEntity<BaseResponse<WarehouseLookupResponse>> getWarehouseLookups(
    ...
    return ResponseEntity.ok(
        BaseResponse.ok(
            "Lấy dữ liệu quản lý kho thành công", warehouseService.getWarehouseLookups()));
  }
  ...
  public ResponseEntity<BaseResponse<WarehouseResponse>> getWarehouseById(
    ...
    return ResponseEntity.ok(
        BaseResponse.ok("Lấy chi tiết kho thành công", warehouseService.getWarehouseById(id)));
  }
  ...
  public ResponseEntity<BaseResponse<WarehouseResponse>> createWarehouse(
    ...
    return ResponseEntity.ok(
        BaseResponse.created("Tạo kho thành công", warehouseService.createWarehouse(request)));
  }
  ...
  public ResponseEntity<BaseResponse<WarehouseResponse>> updateWarehouse(
    ...
    return ResponseEntity.ok(
        BaseResponse.ok("Cập nhật kho thành công", warehouseService.updateWarehouse(id, request)));
  }
  ...
  public ResponseEntity<BaseResponse<WarehouseResponse>> deactivateWarehouse(
    ...
    return ResponseEntity.ok(
        BaseResponse.ok(
            "Ngưng hoạt động kho thành công", warehouseService.deactivateWarehouse(id)));
  }
}
