...
@Tag(
    ...
    description =
        "API tạo và quản lý tài khoản người dùng. Người gọi cần đăng nhập và có quyền phù hợp.")
@RestController
...
public class UserController {
  ...
  @ApiResponses({
    ...
    @ApiResponse(
        responseCode = "403",
        description = "Không có quyền USER:CREATE",
        content = @Content)
  })
  @GetMapping("/lookups")
  public ResponseEntity<BaseResponse<CreateUserLookupResponse>> getCreateUserLookups(
    ...
    return ResponseEntity.ok(BaseResponse.ok("Lấy dữ liệu tạo tài khoản thành công", data));
  }
  ...
  @ApiResponses({
    ...
    @ApiResponse(
        responseCode = "400",
        description = "Dữ liệu không hợp lệ, role không tồn tại hoặc thiếu mã chi nhánh",
        content = @Content),
    @ApiResponse(
        responseCode = "401",
        description = "Chưa đăng nhập hoặc token hết hạn",
    ...
    @ApiResponse(
        responseCode = "403",
        description = "Không có quyền USER:CREATE hoặc vi phạm phạm vi tạo tài khoản",
        content = @Content),
    @ApiResponse(
        responseCode = "409",
