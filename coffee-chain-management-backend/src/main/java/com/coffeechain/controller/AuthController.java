...
public class AuthController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Thiếu tên đăng nhập hoặc mật khẩu", content = @Content),
            @ApiResponse(responseCode = "401", description = "Sai tên đăng nhập hoặc mật khẩu", content = @Content),
            @ApiResponse(responseCode = "403", description = "Tài khoản không hoạt động hoặc bị khóa", content = @Content)
    })
    @PostMapping("/login")
    ...
    public ResponseEntity<BaseResponse<UserInfoResponse>> me(
        ...
        return ResponseEntity.ok(
                BaseResponse.ok("Lấy thông tin người dùng thành công", data)
        );
    }
    ...
    public ResponseEntity<BaseResponse<PermissionCheckResponse>> checkPermission(
        ...
        return ResponseEntity.ok(
                BaseResponse.ok(allowed ? "Có quyền" : "Không có quyền", data)
        );
    }
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "401", description = "Thiếu token hoặc token không hợp lệ", content = @Content)
    })
    @PostMapping("/logout")
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "401", description = "Chưa đăng nhập hoặc token hết hạn", content = @Content),
            @ApiResponse(responseCode = "403", description = "Không có quyền INVENTORY:IMPORT", content = @Content)
    })
    ...
    public ResponseEntity<BaseResponse<Void>> demoInventoryImport(
        ...
        return ResponseEntity.ok(
                BaseResponse.ok("Bạn có quyền INVENTORY:IMPORT", null)
        );
    }
}
