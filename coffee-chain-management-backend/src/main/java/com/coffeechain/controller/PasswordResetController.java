...
public class PasswordResetController {
  ...
  @ApiResponses({
    ...
    @ApiResponse(
        responseCode = "404",
        description = "Email chua ton tai trong he thong",
        content = @Content)
  })
  ...
  @ApiResponses({
    ...
    @ApiResponse(
        responseCode = "400",
        description = "Ma khong dung, khong ton tai hoac da het han",
        content = @Content)
  })
  ...
  public ResponseEntity<BaseResponse<Void>> verifyResetCode(
    ...
    return ResponseEntity.ok(BaseResponse.ok("Ma xac nhan hop le", null));
  }
  ...
  @ApiResponses({
    ...
    @ApiResponse(
        responseCode = "400",
        description = "Du lieu khong hop le, ma sai hoac ma da het han",
        content = @Content)
  })
  ...
  public ResponseEntity<BaseResponse<Void>> resetPassword(
    ...
    return ResponseEntity.ok(BaseResponse.ok("Dat lai mat khau thanh cong", null));
  }
}
