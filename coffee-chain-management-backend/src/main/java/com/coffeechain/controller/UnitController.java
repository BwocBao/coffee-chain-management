...
@Tag(
    name = "Quan ly don vi tinh",
    description =
        "Nhom API Quan ly don vi tinh. Swagger mo ta quyen can co, request, response va luong su dung chinh.")
@RestController
...
public class UnitController {
  ...
  @ApiResponses({
    ...
    @ApiResponse(
        responseCode = "403",
        description = "Không có quyền xem đơn vị tính",
        content = @Content)
  })
  @GetMapping
  public ResponseEntity<BaseResponse<List<UnitResponse>>> searchUnits(
    ...
    return ResponseEntity.ok(
        BaseResponse.ok("Lấy danh sách đơn vị tính thành công", unitService.searchUnits(keyword)));
  }
  ...
  public ResponseEntity<BaseResponse<UnitResponse>> getUnitById(
    ...
    return ResponseEntity.ok(
        BaseResponse.ok("Lấy chi tiết đơn vị tính thành công", unitService.getUnitById(id)));
  }
  ...
  public ResponseEntity<BaseResponse<UnitResponse>> createUnit(
    ...
    return ResponseEntity.ok(
        BaseResponse.created("Tạo đơn vị tính thành công", unitService.createUnit(request)));
  }
  ...
  public ResponseEntity<BaseResponse<UnitResponse>> updateUnit(
    ...
    return ResponseEntity.ok(
        BaseResponse.ok("Cập nhật đơn vị tính thành công", unitService.updateUnit(id, request)));
  }
  ...
  public ResponseEntity<BaseResponse<Void>> deleteUnit(
    ...
    return ResponseEntity.ok(BaseResponse.ok("Xóa đơn vị tính thành công", null));
  }
}
