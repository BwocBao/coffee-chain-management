...
@Tag(
    name = "Quan ly cong thuc san pham",
    description =
        "Nhom API Quan ly cong thuc san pham. Swagger mo ta quyen can co, request, response va luong su dung chinh.")
@RestController
...
public class RecipeController {
  ...
  public ResponseEntity<BaseResponse<RecipeLookupResponse>> getLookups(
    ...
    return ResponseEntity.ok(
        BaseResponse.ok("Lấy dữ liệu quản lý công thức thành công", recipeService.getLookups()));
  }
  ...
  public ResponseEntity<BaseResponse<List<RecipeSummaryResponse>>> searchRecipes(
    ...
    return ResponseEntity.ok(
        BaseResponse.ok(
            "Tra cứu công thức thành công", recipeService.searchRecipes(keyword, status)));
  }
  ...
  public ResponseEntity<BaseResponse<RecipeDetailResponse>> getRecipeDetail(
    ...
    return ResponseEntity.ok(
        BaseResponse.ok(
            "Lấy chi tiết công thức thành công", recipeService.getRecipeDetail(maSanPham)));
  }
  ...
  public ResponseEntity<BaseResponse<RecipeDetailResponse>> createRecipe(
    ...
    return ResponseEntity.ok(
        BaseResponse.created("Tạo công thức thành công", recipeService.createRecipe(request)));
  }
  ...
  public ResponseEntity<BaseResponse<RecipeDetailResponse>> updateRecipe(
    ...
    return ResponseEntity.ok(
        BaseResponse.ok(
            "Cập nhật công thức thành công", recipeService.updateRecipe(maSanPham, request)));
  }
  ...
  public ResponseEntity<BaseResponse<RecipeDetailResponse>> deleteFormula(
    ...
    return ResponseEntity.ok(
        BaseResponse.ok(
            "Xóa công thức hiện hành thành công", recipeService.deleteFormula(maSanPham)));
  }
  ...
  public ResponseEntity<BaseResponse<RecipeDetailResponse>> stopSelling(
    ...
    return ResponseEntity.ok(
        BaseResponse.ok("Ngừng bán sản phẩm thành công", recipeService.stopSelling(maSanPham)));
  }
}
