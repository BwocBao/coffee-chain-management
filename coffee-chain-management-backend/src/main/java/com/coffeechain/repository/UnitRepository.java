...
public class UnitRepository {
    ...
    public UnitRepository(JdbcTemplate jdbcTemplate) {
        ...
        this.unitInsert = new SimpleJdbcInsert(jdbcTemplate)
    ...
    private final RowMapper<UnitResponse> mapper = (rs, rowNum) -> new UnitResponse(
    ...
    public boolean existsById(Long id) {
        Integer count = jdbcTemplate.queryForObject(
                "SELECT COUNT(*) FROM DONVITINH WHERE ma_don_vi_tinh = ?",
                Integer.class,
                id
        );
    ...
    public int deleteUnit(Long id) {
        return jdbcTemplate.update(
                "DELETE FROM DONVITINH WHERE ma_don_vi_tinh = ?",
                id
        );
    }
}