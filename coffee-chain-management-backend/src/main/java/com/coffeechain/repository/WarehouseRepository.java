...
public class WarehouseRepository {
    ...
    public WarehouseRepository(JdbcTemplate jdbcTemplate) {
        ...
        this.warehouseInsert = new SimpleJdbcInsert(jdbcTemplate)
                .withTableName("KHO")
    ...
    private final RowMapper<WarehouseResponse> mapper = (rs, rowNum) -> {
        Long maChiNhanh = rs.getObject("ma_chi_nhanh") == null
                ? null
    ...
    public boolean existsById(Long id) {
        Integer count = jdbcTemplate.queryForObject(
                "SELECT COUNT(*) FROM KHO WHERE ma_kho = ?",
                Integer.class,
                id
        );
    ...
    public List<WarehouseLookupResponse.OptionDto> findActiveBranchOptions() {
        ...
        return jdbcTemplate.query(sql, (rs, rowNum) -> new WarehouseLookupResponse.OptionDto(
                rs.getLong("id"),
                null,
                rs.getString("name"),
