...
public class IngredientRepository {
  ...
  public IngredientRepository(JdbcTemplate jdbcTemplate) {
    ...
    this.ingredientInsert =
        new SimpleJdbcInsert(jdbcTemplate)
            .withTableName("NGUYENLIEU")
            .usingGeneratedKeyColumns("ma_nguyen_lieu")
            .usingColumns("ten_nguyen_lieu", "ma_don_vi_tinh", "muc_ton_toi_thieu", "trang_thai");
  }

  private final RowMapper<IngredientResponse> mapper =
      (rs, rowNum) ->
  ...
  public List<IngredientResponse> searchIngredients(String keyword, String status, Long unitId) {
    StringBuilder sql =
        new StringBuilder(
            """
                SELECT
  ...
  public boolean existsById(Long id) {
    Integer count =
        jdbcTemplate.queryForObject(
            "SELECT COUNT(*) FROM NGUYENLIEU WHERE ma_nguyen_lieu = ?", Integer.class, id);
  ...
  public Long insertIngredient(String name, Long unitId, BigDecimal minimumStock, String status) {
  ...
  public int updateIngredient(
      Long id, String name, Long unitId, BigDecimal minimumStock, String status) {
    String sql =
        """
                UPDATE NGUYENLIEU
                SET ten_nguyen_lieu = ?,
  ...
  public List<IngredientLookupResponse.OptionDto> findUnitOptions() {
    ...
    return jdbcTemplate.query(
        sql,
        (rs, rowNum) ->
            new IngredientLookupResponse.OptionDto(
