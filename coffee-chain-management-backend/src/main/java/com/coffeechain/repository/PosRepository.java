...
public class PosRepository {
    ...
    public PosRepository(JdbcTemplate jdbcTemplate) {
        ...
        this.orderDetailInsert = new SimpleJdbcInsert(jdbcTemplate)
        ...
        this.saleDeductionInsert = new SimpleJdbcInsert(jdbcTemplate)
        ...
        this.payOsPaymentInsert = new SimpleJdbcInsert(jdbcTemplate)
    ...
    public List<PosProductResponse> findPosProducts() {
        return jdbcTemplate.query("""
                ...
                """, (rs, rowNum) -> new PosProductResponse(
    ...
    public ProductOrderRow findProductForOrder(Long maSanPham) {
        List<ProductOrderRow> rows = jdbcTemplate.query("""
                SELECT
                    sp.ma_san_pham,
                    sp.ten_san_pham,
                    sp.gia_ban_hien_tai
    ...
    public boolean posBelongsToBranch(Long maPos, Long maChiNhanh) {
        Integer count = jdbcTemplate.queryForObject("""
                ...
                """, Integer.class, maPos, maChiNhanh);
    ...
    public Optional<OrderRow> findOrder(Long maHoaDon) {
        List<OrderRow> rows = jdbcTemplate.query("""
                ...
                FROM HOADON
                WHERE ma_hoa_don = ?
                """, (rs, rowNum) -> mapOrderRow(rs), maHoaDon);
    ...
    public List<PosOrderItemResponse> findOrderItems(Long maHoaDon) {
        return jdbcTemplate.query("""
                ...
                """, (rs, rowNum) -> new PosOrderItemResponse(
    ...
    public Optional<PosPaymentResponse> findLatestPayOsPayment(Long maHoaDon) {
        List<PosPaymentResponse> rows = jdbcTemplate.query("""
                SELECT
                    order_code,
                    so_tien,
                    mo_ta,
                ...
                """, (rs, rowNum) -> new PosPaymentResponse(
    ...
    public Long findBranchWarehouse(Long maChiNhanh) {
        List<Long> rows = jdbcTemplate.query("""
                ...
                WHERE ma_chi_nhanh = ?
                  AND loai_kho = 'BRANCH'
                  AND trang_thai = 'ACTIVE'
                """, (rs, rowNum) -> rs.getLong("ma_kho"), maChiNhanh);
    ...
    public List<OrderDetailForDeductionRow> findOrderDetailsForDeduction(Long maHoaDon) {
        return jdbcTemplate.query("""
                ...
                """, (rs, rowNum) -> new OrderDetailForDeductionRow(
                rs.getLong("ma_ct_hoa_don"),
                rs.getLong("ma_san_pham"),
                rs.getInt("so_luong")
        ), maHoaDon);
    ...
    public List<RecipeLineRow> findRecipeLines(Long maSanPham) {
        return jdbcTemplate.query("""
                ...
                """, (rs, rowNum) -> new RecipeLineRow(
                rs.getLong("ma_nguyen_lieu"),
                rs.getBigDecimal("so_luong_can")
        ), maSanPham);
    }
    ...
    public Optional<PayOsPaymentRow> findPayOsPaymentForOrder(Long maHoaDon) {
        List<PayOsPaymentRow> rows = jdbcTemplate.query("""
                ...
                ORDER BY ma_thanh_toan DESC
                FETCH FIRST 1 ROWS ONLY
                """, (rs, rowNum) -> mapPayOsPaymentRow(rs), maHoaDon);
    ...
    public Optional<PayOsPaymentRow> findPayOsPaymentById(Long maThanhToan) {
        List<PayOsPaymentRow> rows = jdbcTemplate.query("""
                ...
                FROM THANHTOAN_PAYOS
                WHERE ma_thanh_toan = ?
                """, (rs, rowNum) -> mapPayOsPaymentRow(rs), maThanhToan);
    ...
    public Optional<PayOsPaymentRow> lockPayOsPaymentByOrderCode(Long orderCode) {
        List<PayOsPaymentRow> rows = jdbcTemplate.query("""
                ...
                WHERE order_code = ?
                FOR UPDATE
                """, (rs, rowNum) -> mapPayOsPaymentRow(rs), orderCode);
    ...
    public void markPayOsPaid(Long maThanhToan, String referenceCode, String rawWebhook) {
        jdbcTemplate.update("""
                ...
                SET trang_thai = 'PAID',
                    ...
                    raw_webhook = ?
                WHERE ma_thanh_toan = ?
                """, referenceCode, rawWebhook, maThanhToan);
    }
    ...
    public record OrderDetailForDeductionRow(
            Long maCtHoaDon,
            Long maSanPham,
            Integer soLuong
    ) {
