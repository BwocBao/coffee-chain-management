...
public class InventoryHistoryRepository {
  ...
  private final RowMapper<InventoryHistoryResponse> historyMapper =
      (rs, rowNum) -> {
        ...
        Long maNguoiThaoTac =
            rs.getObject("nguoi_thao_tac") == null ? null : rs.getLong("nguoi_thao_tac");
  ...
  public List<InventoryHistoryResponse> searchHistory(
    ...
    appendCommonFilters(
        sql, params, maKho, maNguyenLieu, maLoHang, loaiGiaoDich, fromDate, toDate, keyword);
  ...
  public List<InventoryHistorySummaryResponse> getSummary(
      Long maKho, Long maNguyenLieu, LocalDateTime fromDate, LocalDateTime toDate) {
    StringBuilder sql =
        new StringBuilder(
            """
                SELECT
