...
public class SupplierRepository {
  ...
  public SupplierRepository(JdbcTemplate jdbcTemplate) {
    ...
    this.supplierInsert =
        new SimpleJdbcInsert(jdbcTemplate)
            ...
            .usingColumns("ten_nha_cung_cap", "so_dien_thoai", "email", "dia_chi");
  }

  private final RowMapper<SupplierResponse> mapper =
      (rs, rowNum) ->
  ...
  public boolean existsById(Long id) {
    Integer count =
        jdbcTemplate.queryForObject(
            "SELECT COUNT(*) FROM NHACUNGCAP WHERE ma_nha_cung_cap = ?", Integer.class, id);
  ...
  public Long insertSupplier(String name, String phone, String email, String address) {
  ...
  public int updateSupplier(Long id, String name, String phone, String email, String address) {
    String sql =
        """
                UPDATE NHACUNGCAP
  ...
  public int deleteSupplier(Long id) {
    return jdbcTemplate.update("DELETE FROM NHACUNGCAP WHERE ma_nha_cung_cap = ?", id);
  }
}
