...
public class InvoicePdfService {
    ...
    public byte[] generateInvoicePdf(Long maHoaDon) {
        InvoiceHeaderRow header = invoicePdfRepository.findInvoiceHeader(maHoaDon)
        ...
        if (!"COMPLETED".equals(header.trangThaiHoaDon())
            ...
            throw new AppException(HttpStatus.BAD_REQUEST, "Chỉ in hóa đơn sau khi thanh toán thành công");
        }
        ...
        try {
            ...
            addInfoLine(document, "Phương thức", formatPaymentMethod(header.phuongThucThanhToan()), normalFont);
            ...
            throw new AppException(HttpStatus.INTERNAL_SERVER_ERROR, "Không tạo được PDF hóa đơn: " + ex.getMessage());
        }
    }
    ...
    private void addInfoLine(Document document, String label, String value, Font font) throws DocumentException {
