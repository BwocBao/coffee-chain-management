...
public class WarehouseService {
    ...
    public WarehouseLookupResponse getWarehouseLookups() {
        ...
        response.setWarehouseTypes(List.of(
                new WarehouseLookupResponse.OptionDto(null, CENTRAL, "Kho tổng", "Kho trung tâm của hệ thống"),
                new WarehouseLookupResponse.OptionDto(null, BRANCH, "Kho chi nhánh", "Kho gắn với một chi nhánh cụ thể")
        ));
    ...
    private void validateWarehouseInput(
        ...
        if (CENTRAL.equals(loaiKho)) {
            ...
            boolean centralExists = creating
        ...
        if (BRANCH.equals(loaiKho)) {
            ...
            boolean branchWarehouseExists = creating
                    ? warehouseRepository.existsWarehouseForBranch(maChiNhanh)
                    : warehouseRepository.existsWarehouseForBranchExceptId(maChiNhanh, currentWarehouseId);
