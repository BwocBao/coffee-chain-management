...
public class IngredientService {
  ...
  private void validateIngredientInput(String name, Long unitId, BigDecimal minimumStock) {
    ...
    if (name.length() > 150) {
      throw new AppException(
          HttpStatus.BAD_REQUEST, "Tên nguyên liệu không được vượt quá 150 ký tự");
    }
