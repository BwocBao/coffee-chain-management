...
public class SwaggerClassNameConfig {
    ...
    private String buildClassInfo(String requestClass, String responseClass) {
        return "Request class: `" + requestClass + "`\n"
    ...
    private String resolveTypeName(Type type) {
        ...
        if (type instanceof ParameterizedType parameterizedType) {
            ...
            if (rawType instanceof Class<?> rawClass && ResponseEntity.class.isAssignableFrom(rawClass) && arguments.length == 1) {
            ...
            String argumentNames = Arrays.stream(arguments)
