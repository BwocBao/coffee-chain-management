...
/**
 * Bộ component custom dùng riêng cho màn {@code TaoTaiKhoanFrame}.
 * Các component này được tách ra để giảm độ dài frame nhưng giữ nguyên style và kích thước cũ.
 */
            ...
            if (imagePath != null && !imagePath.isBlank()) {
                try {
                    ...
                    if (imagePath.toLowerCase().endsWith(".svg")) {
                        ...
                        icon = new ImageIcon(image.getScaledInstance(getWidth() - 28, getHeight() - 28, Image.SCALE_SMOOTH));
                    }
