...
/**
 * Màn home cũ/đơn giản của app.
 * Hiện luồng chính sau login đang đi qua MenuTongFrame, nên class này giữ lại để tham khảo hoặc tái dùng sau.
 */
public class HomeFrame extends JFrame {
    ...
    public HomeFrame() {
        ...
        khoMenuButton.addActionListener(e -> {
