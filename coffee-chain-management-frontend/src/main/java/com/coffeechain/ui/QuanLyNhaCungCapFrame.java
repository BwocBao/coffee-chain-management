...
//    private final JLabel selectedIdLabel = new JLabel("Chưa chọn nhà cung cấp");
    ...
    private final DefaultTableModel supplierTableModel = new DefaultTableModel(
    ...
    private void buildHeader() {
        ...
        JLabel subtitle = new JLabel("Theo dõi thông tin liên hệ và địa chỉ của các nhà cung cấp nguyên liệu");
...
//        selectedIdLabel.setText("Chưa chọn nhà cung cấp");
    ...
    private void addInput(JPanel parent, String labelText, JTextField field, int x, int y, int w, int h) {
