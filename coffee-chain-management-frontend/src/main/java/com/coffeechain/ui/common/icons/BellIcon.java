 ...
 *
 * Đang dùng ở KhoMenuFrame, góc phải phần header của màn quản lý kho.
 * Constructor không tham số dùng màu mặc định; constructor có Color cho phép đổi màu nét vẽ.
 * paintIcon(...) là nơi vẽ hình chuông lên component Swing.
 */
