 ...
 *
 * Đang dùng ở LoginFrame trong ô password; phiên bản riêng của TaoTaiKhoanFrame nằm trong
 * CreateUserUiComponents để giữ pixel/style cũ của màn đó.
 * Tham số open quyết định có gạch chéo hay không, Color quyết định màu nét vẽ.
 */
public class EyeLineIcon implements Icon {
    private final boolean open;
    private final Color color;
    public EyeLineIcon(boolean open, Color color) { this.open = open; this.color = color; }
