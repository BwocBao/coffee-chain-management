 ...
 *
 * Các hằng Color dùng để thống nhất màu giữa các màn.
 * regular(size) và bold(size) tạo Font theo size truyền vào.
 * Khi cần đổi style toàn app, ưu tiên chỉnh tại đây trước khi chỉnh từng màn.
 */
