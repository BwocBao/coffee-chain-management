 ...
 *
 * Đang dùng ở LoginFrame cho checkbox Remember Me.
 * Tham số selected quyết định trạng thái tick, selectedColor là màu khi tick,
 * borderColor là màu viền khi chưa tick.
 */
