...
/**
 * JButton bo góc theo style chung của app.
 * Dùng ở LoginFrame, MenuTongFrame, QuanTriHeThongFrame và các form có nút hành động chính.
 */
public class RoundedButton extends JButton {
    ...
    protected void paintComponent(Graphics g) {
        ...
        Color fill = !isEnabled() ? disabledColor : (getModel().isRollover() ? hoverColor : backgroundColor);
        g2.setColor(fill);
