...
/**
 * Card menu chức năng dạng lớn, có title, mô tả, icon thường và icon hover. Đang dùng ở
 * KhoMenuFrame cho các nghiệp vụ kho.
 */
public class FeatureMenuCard extends JPanel {
  ...
  public FeatureMenuCard(
      String title, String description, Icon normalIcon, Icon hoverIcon, Runnable action) {
    this.action = action;
