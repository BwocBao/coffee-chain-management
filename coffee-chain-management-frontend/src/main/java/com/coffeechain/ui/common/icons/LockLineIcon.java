 ...
 *
 * <p>Đang dùng ở LoginFrame, bên trái ô nhập mật khẩu. Constructor nhận Color để màn đăng nhập có
 * thể dùng đúng màu icon theo thiết kế.
 */
public class LockLineIcon implements Icon {
  private final Color color;

  public LockLineIcon(Color color) {
    this.color = color;
  }
