 ...
 *
 * Đang dùng ở LoginFrame, bên trái ô nhập username.
 * Constructor nhận Color để đồng bộ màu nét với thiết kế của field đăng nhập.
 */
public class UserLineIcon implements Icon {
    private final Color color;
    public UserLineIcon(Color color) { this.color = color; }
