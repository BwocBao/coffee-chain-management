...
/**
 * Panel nền có thể vẽ ảnh từ resources và phủ lớp màu overlay.
 * Đang dùng ở các màn menu như MenuTongFrame và QuanTriHeThongFrame để giữ background đồng nhất.
 */
