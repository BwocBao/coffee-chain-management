...
/**
 * Card module cấp cao trên menu tổng/quản trị hệ thống. Đang dùng ở MenuTongFrame và
 * QuanTriHeThongFrame để mở các nhóm chức năng lớn.
 */
public class MenuModuleCard extends JPanel {
  ...
  public MenuModuleCard(
      String title, String description, Icon icon, Runnable action, boolean compact) {
    this.action = action;
