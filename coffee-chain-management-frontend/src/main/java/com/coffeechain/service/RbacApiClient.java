...
/**
 * Client gọi nhóm API phân quyền RBAC.
 * Được dùng bởi màn PhanQuyenBaoMatFrame để tải role, tải permission và lưu quyền cho role.
 */
public class RbacApiClient {
    ...
    public RolePermissionDto updateRolePermissions(Long roleId, Set<Long> permissionIds) throws Exception {
    ...
    public static class RoleDto {
        ...
        @Override public String toString() { return tenVaiTro; }
    }
