...
public class WarehouseApiClient extends ApiClientSupport {
    ...
    public List<WarehouseDto> searchWarehouses(String keyword, String loaiKho, String trangThai)
        ...
        String url = ApiConfig.WAREHOUSES_URL + (params.isBlank() ? "" : "?" + stripLeadingAmpersand(params));
        ...
        BaseResponse<List<WarehouseDto>> baseResponse = readBaseResponse(
                response,
                new TypeReference<BaseResponse<List<WarehouseDto>>>() {}
        );
    ...
    public WarehouseLookupDto getLookups() throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = send(request);
        BaseResponse<WarehouseLookupDto> baseResponse = readBaseResponse(
                response,
                new TypeReference<BaseResponse<WarehouseLookupDto>>() {}
        );
        return extractData(baseResponse);
    }

    public WarehouseDto createWarehouse(WarehouseRequest requestBody) throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
        ...
        HttpResponse<String> response = send(request);
        BaseResponse<WarehouseDto> baseResponse = readBaseResponse(
                response,
                new TypeReference<BaseResponse<WarehouseDto>>() {}
        );
        return extractData(baseResponse);
    }

    public WarehouseDto updateWarehouse(Long id, WarehouseRequest requestBody) throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
    ...
    public static class WarehouseLookupDto {
        ...
        public List<OptionDto> getWarehouseTypes() { return warehouseTypes; }
        public void setWarehouseTypes(List<OptionDto> warehouseTypes) { this.warehouseTypes = warehouseTypes; }
