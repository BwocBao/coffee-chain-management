...
/**
 * Client goi cac API kho tu frontend Swing. Man nhap kho dung client nay de lay
 * combobox va tao phieu nhap.
 */
public class InventoryApiClient extends ApiClientSupport {
    ...
    public InventoryLookupDto getImportLookups() throws IOException, InterruptedException {
        ...
        BaseResponse<InventoryLookupDto> baseResponse = readBaseResponse(
                response,
                new TypeReference<BaseResponse<InventoryLookupDto>>() {
        }
        );
        return extractData(baseResponse);
    }

    public ImportReceiptDto createImportReceipt(CreateImportReceiptRequest requestBody) throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
        ...
        HttpResponse<String> response = send(request);
        BaseResponse<ImportReceiptDto> baseResponse = readBaseResponse(
                response,
                new TypeReference<BaseResponse<ImportReceiptDto>>() {
        }
        );
        return extractData(baseResponse);
    }
    ...
    public PageResponseDto<InventoryDto> getStock(
        ...
        String url = ApiConfig.INVENTORY_STOCK_URL
                + "?page=" + page
                + "&size=" + size
        ...
        HttpResponse<String> response = send(request);
        BaseResponse<PageResponseDto<InventoryDto>> baseResponse = readBaseResponse(
                response,
                new TypeReference<BaseResponse<PageResponseDto<InventoryDto>>>() {}
        );
        return extractData(baseResponse);
    }
    ...
    public List<BatchInventoryDto> getStockLots(Long maKho, Long maNguyenLieu)
            throws IOException, InterruptedException {
        String params = optionalParamWithoutPrefix("maKho", maKho)
                + optionalParam("maNguyenLieu", maNguyenLieu);
        String url = ApiConfig.INVENTORY_STOCK_LOTS_URL
        ...
        HttpResponse<String> response = send(request);
        BaseResponse<List<BatchInventoryDto>> baseResponse = readBaseResponse(
                response,
                new TypeReference<BaseResponse<List<BatchInventoryDto>>>() {}
        );
        return extractData(baseResponse);
    }

    public StockSummaryDto getStockSummary(Long maKho) throws IOException, InterruptedException {
        String url = ApiConfig.INVENTORY_STOCK_SUMMARY_URL
                + (maKho == null ? "" : "?maKho=" + maKho);
        ...
        HttpResponse<String> response = send(request);
        BaseResponse<StockSummaryDto> baseResponse = readBaseResponse(
                response,
                new TypeReference<BaseResponse<StockSummaryDto>>() {}
        );
        return extractData(baseResponse);
    }
    ...
    public List<InventoryLotDto> getExportLots(Long maKho, Long maNguyenLieu)
            throws IOException, InterruptedException {
        String url = ApiConfig.INVENTORY_EXPORT_LOTS_URL
                + "?maKho=" + maKho
    ...
    public ExportReceiptDto createExportReceipt(CreateExportReceiptRequest requestBody)
        ...
        HttpResponse<String> response = send(request);
        BaseResponse<ExportReceiptDto> baseResponse = readBaseResponse(
                response,
                new TypeReference<BaseResponse<ExportReceiptDto>>() {}
        );
        return extractData(baseResponse);
    }
