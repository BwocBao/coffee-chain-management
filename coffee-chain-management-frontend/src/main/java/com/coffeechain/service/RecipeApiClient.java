...
public class RecipeApiClient extends ApiClientSupport {
  public RecipeLookupDto getLookups() throws IOException, InterruptedException {
    ...
    BaseResponse<RecipeLookupDto> baseResponse =
        readBaseResponse(response, new TypeReference<BaseResponse<RecipeLookupDto>>() {});
    return extractData(baseResponse);
  }

  public List<RecipeSummaryDto> searchRecipes(String keyword, String status)
      throws IOException, InterruptedException {
    String params =
        optionalParamWithoutPrefix("keyword", keyword) + optionalParam("status", status);
    String url =
        ApiConfig.RECIPES_URL + (params.isBlank() ? "" : "?" + stripLeadingAmpersand(params));
    HttpRequest request =
        HttpRequest.newBuilder()
            .uri(URI.create(url))
            .header("Authorization", bearerToken())
            ...
            .build();
    HttpResponse<String> response = send(request);
    BaseResponse<List<RecipeSummaryDto>> baseResponse =
        readBaseResponse(response, new TypeReference<BaseResponse<List<RecipeSummaryDto>>>() {});
  ...
  public RecipeDetailDto getRecipeDetail(Long maSanPham) throws IOException, InterruptedException {
    HttpRequest request =
        HttpRequest.newBuilder()
            ...
            .build();
    HttpResponse<String> response = send(request);
    BaseResponse<RecipeDetailDto> baseResponse =
        readBaseResponse(response, new TypeReference<BaseResponse<RecipeDetailDto>>() {});
    return extractData(baseResponse);
  }
  ...
  public RecipeDetailDto updateRecipe(Long maSanPham, RecipeRequest body)
      throws IOException, InterruptedException {
    HttpRequest request =
        HttpRequest.newBuilder()
            .uri(URI.create(ApiConfig.RECIPES_URL + "/" + maSanPham))
  ...
  public static class RecipeLookupDto {
    ...
    public void setIngredients(List<IngredientOption> ingredients) {
    ...
    public void setStatuses(List<StatusOption> statuses) {
  ...
  public static class IngredientOption {
    ...
    public IngredientOption(Long id, String name, String unit, BigDecimal giaVonDvt) {
      this.id = id;
      this.name = name;
      this.unit = unit;
      this.giaVonDvt = giaVonDvt;
    }
    ...
    public BigDecimal getGiaVonDvt() {
      return giaVonDvt;
    }

    public void setGiaVonDvt(BigDecimal giaVonDvt) {
      this.giaVonDvt = giaVonDvt;
    }
  ...
  public static class StatusOption {
    ...
    public StatusOption(String code, String name) {
      this.code = code;
      this.name = name;
    }
  ...
  public static class RecipeSummaryDto {
    ...
    public String getMaCongThucHienThi() {
      return maCongThucHienThi;
    }

    public void setMaCongThucHienThi(String maCongThucHienThi) {
      this.maCongThucHienThi = maCongThucHienThi;
    }
    ...
    public Integer getSoNguyenLieu() {
      return soNguyenLieu;
    }

    public void setSoNguyenLieu(Integer soNguyenLieu) {
  ...
  public static class RecipeDetailDto {
    ...
    public List<RecipeIngredientLineDto> getItems() {
      return items;
    }

    public void setItems(List<RecipeIngredientLineDto> items) {
      this.items = items;
    }

    public BigDecimal getTongGiaVon() {
      return tongGiaVon;
    }

    public void setTongGiaVon(BigDecimal tongGiaVon) {
      this.tongGiaVon = tongGiaVon;
    }

    public BigDecimal getBienLoiNhuanGop() {
      return bienLoiNhuanGop;
    }

    public void setBienLoiNhuanGop(BigDecimal bienLoiNhuanGop) {
      this.bienLoiNhuanGop = bienLoiNhuanGop;
    }
  }
  ...
  public static class RecipeIngredientLineDto {
    ...
    public Long getMaCongThuc() {
      return maCongThuc;
    }

    public void setMaCongThuc(Long maCongThuc) {
    ...
    public BigDecimal getSoLuongCan() {
      return soLuongCan;
    }

    public void setSoLuongCan(BigDecimal soLuongCan) {
  ...
  public static class RecipeRequest {
    ...
    public List<RecipeIngredientRequest> getItems() {
      return items;
    }

    public void setItems(List<RecipeIngredientRequest> items) {
      this.items = items;
    }
  }
  ...
  public static class RecipeIngredientRequest {
    ...
    public RecipeIngredientRequest(Long maNguyenLieu, BigDecimal soLuongCan) {
      this.maNguyenLieu = maNguyenLieu;
      this.soLuongCan = soLuongCan;
    }
