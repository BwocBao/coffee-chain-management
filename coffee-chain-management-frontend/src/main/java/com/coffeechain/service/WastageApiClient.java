...
public class WastageApiClient extends ApiClientSupport {
  ...
  public WastageLookupDto getLookups() throws IOException, InterruptedException {
    ...
    BaseResponse<WastageLookupDto> baseResponse =
        readBaseResponse(response, new TypeReference<BaseResponse<WastageLookupDto>>() {});
    return extractData(baseResponse);
  }

  public List<WastageLotDto> getAvailableLots(Long maKho, Long maNguyenLieu)
      throws IOException, InterruptedException {
    String url =
        ApiConfig.INVENTORY_WASTAGE_LOTS_URL + "?maKho=" + maKho + "&maNguyenLieu=" + maNguyenLieu;
    ...
    HttpResponse<String> response = send(request);
    BaseResponse<List<WastageLotDto>> baseResponse =
        readBaseResponse(response, new TypeReference<BaseResponse<List<WastageLotDto>>>() {});
    return extractData(baseResponse);
  }
  ...
  public List<WastageDto> searchWastages(
    ...
    String url =
        ApiConfig.INVENTORY_WASTAGES_URL + (params.isBlank() ? "" : "?" + params.substring(1));
    ...
    HttpResponse<String> response = send(request);
    BaseResponse<List<WastageDto>> baseResponse =
        readBaseResponse(response, new TypeReference<BaseResponse<List<WastageDto>>>() {});
    return extractData(baseResponse);
  }

  public WastageDto createWastage(CreateWastageRequest requestBody)
      throws IOException, InterruptedException {
    HttpRequest request =
        HttpRequest.newBuilder()
    ...
    HttpResponse<String> response = send(request);
    BaseResponse<WastageDto> baseResponse =
        readBaseResponse(response, new TypeReference<BaseResponse<WastageDto>>() {});
    return extractData(baseResponse);
  }
  ...
  public static class WastageDto {
    ...
    public String getNgayHaoHut() {
      return ngayHaoHut;
    }

    public void setNgayHaoHut(String ngayHaoHut) {
