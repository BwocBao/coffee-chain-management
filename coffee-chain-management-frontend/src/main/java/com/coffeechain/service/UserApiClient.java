...
public class UserApiClient extends ApiClientSupport {
    ...
    public CreateUserResponse createUser(CreateUserRequest requestBody) throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
        ...
        BaseResponse<CreateUserResponse> baseResponse = readBaseResponse(
                response,
                new TypeReference<BaseResponse<CreateUserResponse>>() {}
        );
