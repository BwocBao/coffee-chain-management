...
public class StocktakeApiClient extends ApiClientSupport {
  ...
  public StocktakeLookupDto getLookups() throws IOException, InterruptedException {
    ...
    BaseResponse<StocktakeLookupDto> baseResponse =
        readBaseResponse(response, new TypeReference<BaseResponse<StocktakeLookupDto>>() {});
    return extractData(baseResponse);
  }

  public List<StocktakeSystemStockDto> getSystemStock(Long maKho, Long maNguyenLieu)
      throws IOException, InterruptedException {
    String params = optionalParam("maKho", maKho) + optionalParam("maNguyenLieu", maNguyenLieu);
    String url =
        ApiConfig.INVENTORY_STOCKTAKE_SYSTEM_STOCK_URL
    ...
    HttpResponse<String> response = send(request);
    BaseResponse<List<StocktakeSystemStockDto>> baseResponse =
        readBaseResponse(
            response, new TypeReference<BaseResponse<List<StocktakeSystemStockDto>>>() {});
    return extractData(baseResponse);
  }

  public List<StocktakeDto> searchStocktakes(
      Long maKho, String trangThai, String fromDate, String toDate, String keyword)
      throws IOException, InterruptedException {
    String params =
    ...
    String url =
        ApiConfig.INVENTORY_STOCKTAKES_URL + (params.isBlank() ? "" : "?" + params.substring(1));
    ...
    HttpResponse<String> response = send(request);
    BaseResponse<List<StocktakeDto>> baseResponse =
        readBaseResponse(response, new TypeReference<BaseResponse<List<StocktakeDto>>>() {});
    return extractData(baseResponse);
  }
  ...
  public StocktakeDto getById(Long id) throws IOException, InterruptedException {
    ...
    HttpResponse<String> response = send(request);
    BaseResponse<StocktakeDto> baseResponse =
        readBaseResponse(response, new TypeReference<BaseResponse<StocktakeDto>>() {});
    return extractData(baseResponse);
  }

  public StocktakeDto createStocktake(StocktakeRequest requestBody)
      throws IOException, InterruptedException {
    HttpRequest request =
        HttpRequest.newBuilder()
  ...
  public StocktakeDto updateStocktake(Long id, StocktakeRequest requestBody)
      throws IOException, InterruptedException {
    HttpRequest request =
        HttpRequest.newBuilder()
            .uri(URI.create(ApiConfig.INVENTORY_STOCKTAKES_URL + "/" + id))
  ...
  public static class StocktakeSystemStockDto {
    ...
    public String toString() {
      String qty =
          soLuongHeThong == null ? "0" : soLuongHeThong.stripTrailingZeros().toPlainString();
  ...
  public static class StocktakeDto {
    ...
    public List<StocktakeItemDto> getItems() {
      return items;
    }

    public void setItems(List<StocktakeItemDto> items) {
      this.items = items;
    }
  }
