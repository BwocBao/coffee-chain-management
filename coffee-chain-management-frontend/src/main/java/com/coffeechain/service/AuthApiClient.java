...
/**
 * Client gọi nhóm API xác thực: login, logout, thông tin user hiện tại và kiểm tra quyền.
 * Được dùng chủ yếu bởi LoginFrame, menu chính và các helper phân quyền.
 */
public class AuthApiClient extends ApiClientSupport {
    public LoginResponse login(String tenDangNhap, String matKhau) throws IOException, InterruptedException {
    ...
    public ForgotPasswordResponse forgotPassword(String email) throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = send(request);
        BaseResponse<ForgotPasswordResponse> baseResponse = readBaseResponse(
                response,
                new TypeReference<BaseResponse<ForgotPasswordResponse>>() {}
        );
        return extractData(baseResponse);
    }
    ...
    public void resetPassword(String email, String code, String newPassword) throws IOException, InterruptedException {
    ...
    public UserInfoResponse getMe() throws IOException, InterruptedException {
        ...
        BaseResponse<UserInfoResponse> baseResponse = readBaseResponse(
                response,
                new TypeReference<BaseResponse<UserInfoResponse>>() {}
        );
    ...
    public Set<String> getPermissions() throws IOException, InterruptedException {
        ...
        BaseResponse<Set<String>> baseResponse = readBaseResponse(
                response,
                new TypeReference<BaseResponse<Set<String>>>() {}
        );

        return extractData(baseResponse);
    }

    public PermissionCheckResponse checkPermission(String permission) throws IOException, InterruptedException {
        String url = ApiConfig.CHECK_PERMISSION_URL
                + "?permission="
        ...
        BaseResponse<PermissionCheckResponse> baseResponse = readBaseResponse(
                response,
                new TypeReference<BaseResponse<PermissionCheckResponse>>() {}
        );
