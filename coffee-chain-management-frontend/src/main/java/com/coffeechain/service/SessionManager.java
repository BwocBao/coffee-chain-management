...
/**
 * Lưu phiên đăng nhập hiện tại trong bộ nhớ của app Swing. Các màn hình dùng class này để lấy
 * token, thông tin user và kiểm tra quyền trước khi hiển thị chức năng.
 */
